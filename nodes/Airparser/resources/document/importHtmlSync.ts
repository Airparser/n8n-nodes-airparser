...
const showOnlyForImportHtmlSync = {
	operation: ['importTextHtmlSync'],
};

export const importHtmlSyncDescription: INodeProperties[] = [
	{
		...inboxSelect,
		displayOptions: { show: showOnlyForImportHtmlSync },
	},
...
export const importHtmlSyncPreSend: PreSendAction = async function (this, requestOptions) {
